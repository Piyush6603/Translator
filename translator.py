...
arrow_image=PhotoImage(file="hi.png")
...
label1=Label(root,text="English",font="segoe 30 ", bg="white",width=14,bd=5,relief=GROOVE,background="lightyellow")
...
label2=Label(root,text="ENGLISH",font="segoe 30 ", bg="white",width=14,bd=5,relief=GROOVE,background="lightyellow")
